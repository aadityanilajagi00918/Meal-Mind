...
> 🎥 \*\[Demo video placeholder — record phone in hand: toggle Wi-Fi / mobile data / Bluetooth off on camera, log a dish, watch macros update instantly. Embed here before submitting.]\*

## Try it

|||
|-|-|
|**Live demo**|[*\[GitHub Pages link — add once deployed]*](https://aadityanilajagi00918.github.io/Meal-MInd/)|
